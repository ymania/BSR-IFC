...
P1–P4 对应 `spec/01`–`spec/04`。另有：

- `spec/00-strategy.md` — 收敛战略（仓库角色、迁移规则），定义 P1–P4 的设计关系
- `spec/05-extension-layers.md` — MVP 验证过的扩展层提案（Knowledge / Semantic / Digital Thread / Simulation / Memory / Governance 等）
